#!/bin/sh
set -e
# Code generated by https://github.com/bketelsen/toolbox/ DO NOT EDIT.
#
...
Usage: $this [-b] bindir [-d] [tag]
  ...
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/micro/mucl/releases
   If tag is missing, then the latest will be used.

 Generated by toolgen
  https://github.com/bketelsen/toolbox/toolgen
